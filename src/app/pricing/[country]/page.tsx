...
interface PlanFeature {
  ...
  included: boolean;
  highlight?: boolean;
  bonus?: boolean;  // 🆕 للميزات الإضافية (Early Access)
}
...
const COUNTRIES: Record<CountryCode, CountryConfig> = {
  eg: {
    ...
    color: '#FFD700',
    ctaText: 'ابدئي رحلة طفلك دلوقتي',
    trustText: 'أكتر من 5,000 أم مصرية وثقوا فينا',
  },
  sa: {
    code: 'sa',
    name: 'السعودية',
        ...
        <motion.div
          ...
          style={{
            ...
            background: `radial-gradient(circle, ${
              ['#FF4D6D', '#4CC9F0', '#9D4EDD', '#FFD700', '#06D6A0'][i]
            }18 0%, transparent 70%)`,
            left: `${(i * 20) % 100}%`,
            top: `${(i * 22) % 100}%`,
            filter: 'blur(40px)',
      ...
      {Array.from({ length: 20 }).map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            background: ['#FF4D6D', '#4CC9F0', '#9D4EDD', '#FFD700', '#06D6A0', '#fff'][
...
function FreeTrialBanner({ onTryFree }: { onTryFree: () => void }) {
  return (
    ...
    >
      ...
      <div
        className="relative rounded-3xl overflow-hidden border-2 backdrop-blur-md"
        style={{
        ...
        <div className="relative p-6 md:p-8 text-center space-y-4">
          ...
          <div className="space-y-2">
            <h2 className="text-xl md:text-2xl font-black text-white">
              مش متأكدة؟ جرّبي قبل ما تشتركي!
            </h2>
            <p className="text-sm md:text-base text-white/80 font-medium">
              خلي طفلك يجرّب <span className="text-[#06D6A0] font-black">أول درس كامل مجاناً</span> في اللغة الألمانية
              <br />
              <span className="text-white/60 text-xs">بدون بطاقة ائتمان • بدون تسجيل • ابدأ فوراً</span>
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 text-xs font-bold">
            {['🎮 ألعاب تفاعلية', '🎧 نطق حقيقي', '⭐ نظام نقاط'].map((item, i) => (
              <span key={i} className="bg-white/10 px-3 py-1.5 rounded-full text-white/90">
                {item}
              </span>
            ))}
          </div>
          ...
          <motion.button
            ...
            whileHover={{ 
              scale: 1.05,
              boxShadow: '0 0 50px rgba(6,214,160,0.7)',
            }}
            whileTap={{ scale: 0.95 }}
            animate={{
              boxShadow: [
                '0 8px 30px rgba(6,214,160,0.4)',
                '0 12px 40px rgba(6,214,160,0.6)',
                '0 8px 30px rgba(6,214,160,0.4)',
              ],
            }}
            transition={{
    ...
    >
      <div className="text-center space-y-4 mb-8">
        ...
        <p className="text-gray-300 text-sm max-w-lg mx-auto">
          نتحدث معاكي بشفافية كاملة عن اللغات المتاحة والقادمة
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {AVAILABLE_LANGUAGES.map((lang, i) => (
          <motion.div
            ...
            className={`
              relative p-5 rounded-2xl backdrop-blur-md border-2 transition-all duration-300
              ${
                lang.available
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-white/80 text-[13px] leading-relaxed font-medium">
              اشتركي في <span className="text-[#FFD700] font-black">الخطة السنوية</span> الآن، 
              وأي لغة جديدة هتنزل خلال سنة اشتراكك <span className="text-[#06D6A0] font-black">هتفتحلك تلقائياً مجاناً!</span>
              <br />
              <span className="text-white/60 text-xs">
                يعني لو نزلت الإسبانية بعد شهرين، هتلاقيها مفتوحة في حسابك بدون أي تكلفة إضافية 🎁
              </span>
            </p>
          </div>
        </div>
...
function PricingCard({
  ...
  return (
    <motion.div
      ...
      className={`
        relative rounded-[28px] overflow-hidden backdrop-blur-md
      ...
      style={
        isPopular
          ? {
              ...
              boxShadow: `0 0 50px ${color}20, 0 20px 40px rgba(0,0,0,0.3)`,
            }
          : {}
      }
    >
      {isPopular && (
        <>
          <div
            className="absolute -top-20 left-1/2 -translate-x-1/2 w-64 h-40 rounded-full blur-[80px]"
            style={{ backgroundColor: color, opacity: 0.2 }}
          />
          <div
            className="absolute -bottom-10 left-1/2 -translate-x-1/2 w-48 h-32 rounded-full blur-[60px]"
      ...
      {isPopular && (
        <div
          className="absolute top-0 left-0 right-0 py-2.5 text-center text-xs font-black text-white z-10"
          style={{
      ...
      <div className={`relative z-10 p-8 ${isPopular ? 'pt-14' : 'pt-8'} space-y-6`}>
        ...
        <div className="text-center space-y-1">
          ...
          {savings && (
            ...
            >
              ...
              <span className="text-[11px] font-black text-[#06D6A0]">
                وفّر {savings}
              </span>
            </motion.div>
          )}
        ...
        <motion.button
          whileHover={{
            scale: 1.03,
            boxShadow: isPopular ? `0 0 40px ${color}50` : `0 0 25px ${color}30`,
          }}
          whileTap={{ scale: 0.97 }}
...
export default function CountryPricingPage() {
  ...
  const quarterlySaving = Math.round(
    ((monthlyTotal3 - country.plans.quarterly) / monthlyTotal3) * 100
  );
  const yearlySaving = Math.round(
    ((monthlyTotal12 - country.plans.yearly) / monthlyTotal12) * 100
  );
  const yearlyPerMonth = Math.round(country.plans.yearly / 12);
  const quarterlyPerMonth = Math.round(country.plans.quarterly / 3);

  // 🆕 الميزات - محدّثة بالـ Early Access
  ...
  // 🆕 الخطة السنوية - مع Early Access كميزة قوية
  ...
  const countryFAQ = [
    {
      ...
      a: 'أيوا! تقدري تجربي أول درس كامل في اللغة الألمانية مجاناً تماماً بدون بطاقة ائتمان. اضغطي على زر "جرّب أول درس مجاناً" في الأعلى.',
      color: '#06D6A0',
    },
    {
      q: 'إيه هي مكافأة الوصول المبكر (Early Access)؟',
      a: 'دي مكافأة حصرية لمشتركي الخطة السنوية! لو اشتركتي في الألمانية اليوم، وبعد شهر نزلت الإسبانية، هتلاقيها مفتوحة في حسابك مجاناً! نفس الحال مع أي لغة جديدة تنزل خلال سنة اشتراكك.',
      color: '#FFD700',
    },
    {
      q: 'ليه اللغات التانية مش متاحة دلوقتي؟',
      a: 'إحنا حريصين نقدم محتوى بأعلى جودة ممكنة. الألمانية جاهزة 100% دلوقتي، والإسبانية قريباً جداً، وباقي اللغات في مراحل الإنتاج النهائية. مع الخطة السنوية، هتحصلي عليها كلها مجاناً بمجرد نزولها!',
      color: '#4CC9F0',
    },
    {
      q: 'أقدر أغيّر الخطة بعد الاشتراك؟',
      a: 'طبعاً! تقدري تترقي من الشهري للسنوي في أي وقت وهنحسبلك الفرق. أو تلغي الاشتراك في أي وقت.',
      color: '#9D4EDD',
    },
    {
      q: 'لو مش عاجبني، أقدر أرجّع فلوسي؟',
      a: 'أكيد! عندنا ضمان استرجاع كامل خلال 14 يوم من أول اشتراك. لو مش مناسب، فلوسك ترجعلك بالكامل.',
      color: '#F72585',
    },
    {
    ...
    },
    {
      ...
      a: 'الاشتراك لحساب طفل واحد. لو عندك أكتر من طفل، تواصلي معانا للحصول على خصم عائلي مميز.',
      color: '#FF6B35',
    },
  ];
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-[#1a1a3e] via-[#2d1b4e] to-[#1e1b4b] text-white font-sans overflow-x-hidden selection:bg-[#FF4D6D] selection:text-white relative"
      dir="rtl"
    >
      <FloatingParticles />
      ...
      <section className="w-full max-w-5xl mx-auto text-center px-6 space-y-6 z-10 relative mb-8">
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(255,77,109,0.08), rgba(157,78,221,0.08))',
            borderColor: 'rgba(255,255,255,0.12)',
          }}
        >
          <p className="text-sm md:text-base text-gray-300 font-medium leading-relaxed">
            <span className="text-[#FF4D6D] font-black line-through">
              {country.comparisonText}
            </span>
            <br />
        ...
        >
          ...
          <p className="text-white/80 text-sm font-black mt-2">
            الأسعار بـ{country.currency}
          </p>
        </motion.div>
      </section>
        ...
        >
          <div className="flex flex-wrap justify-center gap-3 md:gap-4 text-xs font-bold text-gray-400">
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-1.5 bg-white/[0.04] px-3 py-2 rounded-xl border border-white/[0.08]"
              >
      ...
      {/* ═══════════════════════════════════════════════════════════ */}
      {/* 🌍 قسم اللغات المتاحة والقادمة - جديد! */}
      {/* ═══════════════════════════════════════════════════════════ */}
      ...
      <section className="w-full max-w-4xl mx-auto px-6 pb-24 z-10 relative">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white via-pink-100 to-purple-100">
            قارني بين الخطط واختاري الأنسب
          </h2>
        </motion.div>
                ...
                <tr className="border-b border-white/10">
                  ...
                  <th className="p-5 text-center w-1/5">
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-gray-400">
                        {country.plans.monthly} {country.currencySymbol}
                      </div>
                    </div>
                  </th>
                  <th className="p-5 text-center w-1/5">
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-gray-400">
                        {country.plans.quarterly} {country.currencySymbol}
                      </div>
                    </div>
                  </th>
                  <th className="p-5 text-center w-1/5 relative">
                    ...
                    <div className="relative space-y-1">
                      ...
                      <div className="text-xs text-gray-400">
                        {country.plans.yearly} {country.currencySymbol}
                      </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#FF4D6D] to-[#9D4EDD] flex items-center justify-center font-black text-lg shadow-lg shadow-[#FF4D6D]/30">
                P
              </div>
            ...
            <p className="text-[11px] text-gray-500 font-bold">
              ...
              <span dir="ltr" className="inline-block mx-1">PIXA WORLD</span>
              . جميع الحقوق محفوظة
            </p>
          </div>
        </div>
