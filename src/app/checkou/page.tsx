              ...
              <div className="space-y-4">
                <div className="p-4 rounded-2xl bg-[#010103]/40 border border-white/5 space-y-3">
                  ...
                  <div className="flex items-center justify-between bg-white/5 p-3 rounded-xl border border-white/10">
                    <span className="text-lg font-black tracking-widest text-[#06D6A0]" dir="ltr">01515023109</span>
                    <span className="text-[10px] bg-[#06D6A0]/20 text-[#06D6A0] px-2.5 py-1 rounded-full font-black">نشط ومؤكد ✅</span>
                  </div>
            ...
            <form onSubmit={handleCompletePayment} className="bg-white/[0.06] border border-white/12 rounded-3xl p-6 space-y-5 backdrop-blur-md shadow-xl">
              ...
              <div className="text-center">
                <span className="text-[10px] text-gray-400 font-bold flex items-center justify-center gap-1.5">
                  <Lock size={10} className="text-[#06D6A0]" /> بيانات طفلك مشفرة وآمنة تماماً بالكامل
                </span>
              </div>
            </form>
            ...
            <div className="bg-gradient-to-b from-white/[0.08] to-white/[0.03] border border-white/12 rounded-3xl p-6 backdrop-blur-md shadow-xl space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs bg-[#FFD700]/20 text-[#FFD700] px-2 py-0.5 rounded-full font-black">مميز ✨</span>
                </div>
